...
public class SmoothProgressDrawable extends Drawable implements Animatable {
    ...
    public SmoothProgressDrawable(Interpolator interpolator, int sectionsCount, int separatorLength, int[] colors, int width, float speed, boolean reversed, boolean mirrorMode) {
        mRunning = false;
