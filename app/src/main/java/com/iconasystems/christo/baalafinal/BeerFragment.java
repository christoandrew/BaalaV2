...
public class BeerFragment extends ListFragment {
    ...
    /*private static final String url_get_drink_menu = "http://api.baala-online.netii.net/get_beers.php";*/
    private static final String url_get_drink_menu = "http://10.0.3.2/baala/get_beers.php";
    ...
    class LoadBars extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Loading Drinks...Please Wait");
            ...
            try {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Log.d("Beers", drinkMenu.toString());
