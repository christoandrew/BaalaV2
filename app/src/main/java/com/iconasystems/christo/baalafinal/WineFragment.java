 ...
 */
public class WineFragment extends ListFragment {
    ...
    /*private static final String url_get_drink_menu = "http://api.baala-online.netii.net/baala/get_wine.php";*/
    private static final String url_get_drink_menu = "http://10.0.3.2/baala/baala/get_wine.php";
