 ...
 */
public class SoftDrinksFragment extends ListFragment {
    ...
    /*private static final String url_get_drink_menu = "http://api.baala-online.netii.net/get_soft_drinks.php";*/
    private static final String url_get_drink_menu = "http://10.0.3.2/baala/get_soft_drinks.php";
